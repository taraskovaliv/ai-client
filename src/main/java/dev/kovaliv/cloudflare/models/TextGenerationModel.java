...
public class TextGenerationModel extends AbstractModel {
    ...
    public static final TextGenerationModel LLAMA_3_8B_INSTRUCT = new TextGenerationModel("@cf/meta/llama-3-8b-instruct");
    public static final TextGenerationModel LLAMA_3_8B_INSTRUCT_AWQ = new TextGenerationModel("@cf/meta/llama-3-8b-instruct-awq");
    public static final TextGenerationModel LLAMA_3_1_70B_INSTRUCT = new TextGenerationModel("@cf/meta/llama-3.1-70b-instruct");
    public static final TextGenerationModel LLAMA_3_1_8B_INSTRUCT = new TextGenerationModel("@cf/meta/llama-3.1-8b-instruct");
    public static final TextGenerationModel LLAMA_3_1_8B_INSTRUCT_AWQ = new TextGenerationModel("@cf/meta/llama-3.1-8b-instruct-awq");
    public static final TextGenerationModel LLAMA_3_1_8B_INSTRUCT_FAST = new TextGenerationModel("@cf/meta/llama-3.1-8b-instruct-fast");
    public static final TextGenerationModel LLAMA_3_1_8B_INSTRUCT_FP8 = new TextGenerationModel("@cf/meta/llama-3.1-8b-instruct-fp8");
    public static final TextGenerationModel LLAMA_3_2_11B_VISION_INSTRUCT = new TextGenerationModel("@cf/meta/llama-3.2-11b-vision-instruct");
    public static final TextGenerationModel LLAMA_3_2_1B_INSTRUCT = new TextGenerationModel("@cf/meta/llama-3.2-1b-instruct");
    public static final TextGenerationModel LLAMA_3_2_3B_INSTRUCT = new TextGenerationModel("@cf/meta/llama-3.2-3b-instruct");
    ...
    public static final TextGenerationModel DEEPSEEK_MATH_7B_BASE = new TextGenerationModel("@cf/deepseek-ai/deepseek-math-7b-base");
    ...
    public static final TextGenerationModel META_LLAMA_3_8B_INSTRUCT = new TextGenerationModel("@hf/meta-llama/meta-llama-3-8b-instruct");
    ...
    public static final TextGenerationModel UNA_CYBERTRON_7B_V2_BF16 = new TextGenerationModel("@cf/fblgit/una-cybertron-7b-v2-bf16");
